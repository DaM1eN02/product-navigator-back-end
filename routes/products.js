...
const invocationName = "product navigator";
...
const GetProductInformation_Handler =  {
    ...
    handle(handlerInput) {
        ...
        let say = 'Hello from GetProductInformation. ';
...
const model = {
  "interactionModel": {
    "languageModel": {
      "invocationName": "product navigator",
      "intents": [
        {
        ...
        },
        {
          ...
          "samples": [
            "Suche {product}",
            "Wie viel kostet {product}",
            "Wie lautet der Preis von {product}",
            "Wie viele hat das {product}",
            "Sag mir den von {product}"
          ]
        },
        {
          "name": "LaunchRequest"
